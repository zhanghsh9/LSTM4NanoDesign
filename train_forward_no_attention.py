...
from models import ForwardNoAttentionLSTM
...
if __name__ == '__main__':
    ...
    shutil.copyfile('train_forward_no_attention.py',
                    os.path.join(RESULTS_PATH, timestamp, 'train_forward_no_attention.py'))
    ...
    forward_model = ForwardNoAttentionLSTM(input_len=input_len, hidden_units=HIDDEN_UNITS, out_len=out_len,
