...
if __name__ == '__main__':
    ...
    shutil.copyfile('train_forward_self_deltaed.py',
                    os.path.join(RESULTS_PATH, timestamp, 'train_forward_self_deltaed.py'))
    ...
    forward_model = ForwardSelfAttentionLSTM(input_len=input_len, hidden_units=HIDDEN_UNITS,
