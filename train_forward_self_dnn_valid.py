...
from models import ForwardSelfAttentionDNN
...
from parameters import RESULTS_PATH, DATA_PATH, FIGS_PATH, MODEL_PATH, RODS, BATCH_SIZE, NUM_WORKERS, SAMPLE_RATE, \
    LEARNING_RATE, EPOCHS, NUM_LAYERS, HIDDEN_UNITS, STEP_SIZE, GAMMA, ACTIVATE_FUNC, DROPOUT
...
if __name__ == '__main__':
    ...
    timestamp = '20250306_none'
    RESULTS_PATH = os.path.join(RESULTS_PATH, 'self_attention_dnn')
    ...
    shutil.copyfile('train_forward_self_dnn_valid.py',
                    os.path.join(RESULTS_PATH, timestamp, 'train_forward_self_dnn_valid.py'))
    ...
    train_dataset, test_dataset, valid_dataset = create_dataset(data_path=DATA_PATH, rods=RODS, use_TL_TR='TL',
    ...
    forward_model = ForwardSelfAttentionDNN(input_len=input_len, hidden_units=HIDDEN_UNITS, out_len=out_len,
